...
const Overview = ({ language }) => {
  ...
  const content = {
    ...
    KO: {
      ...
      Path of Value`,
      description: [
        `그래비티자산운용은 대체투자에 특화된 자산운용사로,
        상업용 부동산과 사회기반시설 투자를 통해 고객의 자산을 운용하고 있습니다.

        **업계 최고의 전문가들로 구성된 독립계 자산운용사**로서,
        구성원의 풍부한 경험과 폭넓은 네트워크를 바탕으로
        우수한 투자 기회를 발굴하여 고객에게 제공하고 있으며,
        체계적이고 전문적인 관리를 통해 투자 자산의 가치 증대 및
        우수한 투자 성과를 달성할 수 있도록 최선의 노력을 다하겠습니다.

        그래비티자산운용은 임직원 및 특수관계자 100% 지분을 보유한 회사로,
        **회사와 임직원, 투자자가 하나의 목표를 공유**하며 함께 성장하는 조직입니다.

        철저한 준법정신과 신의성실의 원칙을 바탕으로 최고의 투자 성과를 달성하기 위해
        임직원 모두가 한마음으로 최선을 다하겠습니다.
